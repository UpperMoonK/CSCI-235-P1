...
int main() {
    // Create a wizard
    Wizard* merlin = new Wizard("Merlin", HUMANOID, DEATH, 100, 1, false, 4);

    // Create enemies
    Firecat* firecat = new Firecat("Blazer", ANIMAL, STORM, 1, 30, 5, 0, Firecat::RED, 60, 1);
    Banshee* banshee = new Banshee("Wailer", UNDEAD, DEATH, 1, 40, 3, 1, Banshee::BLUE, 4, 0);
    CatThug* thug = new CatThug("Whiskers", HUMANOID, MYTH, 1, 25, 7);
